...
//        DataStream<String> text = env.readTextFile("/Users/AzeezA/Google Drive/Life/2021/UPM/CloudComputing/sample-traffic-3xways.csv");
        DataStream<String> text = env.readTextFile(inFilePath);
        System.out.println("after file load");
        ...
        maxSpeed.writeAsCsv(outFilePath + "/SpeedRadar.csv");
        System.out.println("saved to " + outFilePath + "/SpeedRadar.csv");
        ...
        avgSpeed.writeAsCsv(outFilePath + "/AverageSpeedControl.csv");
        System.out.println("saved to " + outFilePath + "/AverageSpeedControl.csv");
        ...
        stoppedCars.writeAsCsv(outFilePath + "/AccidentReporter.csv");
        System.out.println("saved to " + outFilePath + "/AccidentReporter.csv");
        ...
        // execute program
        env.execute("Vehicle Telematics Project");
    }
}
